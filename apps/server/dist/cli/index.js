...
program
    ...
    try {
        ...
        const { runLoadCommand } = await Promise.resolve().then(() => __importStar(require("./commands/load")));
...
program
    ...
    try {
        ...
        const { runStartCommand } = await Promise.resolve().then(() => __importStar(require("./commands/start")));
